...
namespace TES3 {
	...
	const auto TES3_AnimationData_updateMovementDelta = reinterpret_cast<bool(__thiscall*)(AnimationData*, float, NI::Vector3*, bool)>(0x470320);
	void AnimationData::updateMovementDelta(float timing, NI::Vector3 *inout_startingPosition, bool dontUpdatePositionDelta) {
