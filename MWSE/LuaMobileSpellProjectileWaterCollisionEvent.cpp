...
namespace mwse::lua::event {
	MobileSpellProjectileWaterCollisionEvent::MobileSpellProjectileWaterCollisionEvent(TES3::MobileSpellProjectile* projectile, TES3::Reference* targetReference, NI::Point3& point, NI::Point3& pos, NI::Point3& vel) :
		ObjectFilteredEvent("spellProjectileHitWater", projectile->firingActor ? projectile->firingActor->reference : nullptr),
	...
	sol::table MobileSpellProjectileWaterCollisionEvent::createEventTable() {
