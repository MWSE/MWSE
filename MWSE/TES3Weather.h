...
namespace TES3 {
	...
	struct Weather {
		...
		NI::Vector3 ambientSunriseCol; // 0x14
		NI::Vector3 ambientDayCol; // 0x20
		NI::Vector3 ambientSunsetCol; // 0x2C
		NI::Vector3 ambientNightCol; // 0x38
		NI::Vector3 fogSunriseCol; // 0x44
		NI::Vector3 fogDayCol; // 0x50
		NI::Vector3 fogSunsetCol; // 0x5C
		NI::Vector3 fogNightCol; // 0x68
		NI::Vector3 skySunriseCol; // 0x74
		NI::Vector3 skyDayCol; // 0x80
		NI::Vector3 skySunsetCol; // 0x8C
		NI::Vector3 skyNightCol; // 0x98
		NI::Vector3 sunSunriseCol; // 0xA4
		NI::Vector3 sunDayCol; // 0xB0
		NI::Vector3 sunSunsetCol; // 0xBC
		NI::Vector3 sunNightCol; // 0xC8
		NI::Vector3 sundiscSunsetCol; // 0xD4
		float unknown_0xE0;
		NI::Vector3 unknown_0xE4;
