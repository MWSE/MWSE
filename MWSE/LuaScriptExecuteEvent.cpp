...
namespace mwse::lua::event {
	ScriptExecuteEvent::ScriptExecuteEvent(TES3::Script* script, TES3::Reference* reference, TES3::ScriptVariables* variables, TES3::DialogueInfo* info, TES3::Reference* reference2) :
		ObjectFilteredEvent("scriptExecute", script),
		m_Script(script),
	...
	sol::table ScriptExecuteEvent::createEventTable() {
