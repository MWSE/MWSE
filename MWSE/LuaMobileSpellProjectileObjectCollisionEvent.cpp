...
namespace mwse::lua::event {
	MobileSpellProjectileObjectCollisionEvent::MobileSpellProjectileObjectCollisionEvent(TES3::MobileSpellProjectile* projectile, TES3::Reference* targetReference, NI::Point3& point, NI::Point3& pos, NI::Point3& vel) :
		ObjectFilteredEvent("spellProjectileHitObject", projectile->firingActor ? projectile->firingActor->reference : nullptr),
	...
	sol::table MobileSpellProjectileObjectCollisionEvent::createEventTable() {
