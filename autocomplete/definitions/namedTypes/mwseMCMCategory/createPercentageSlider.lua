return {
	type = "method",
	description = [[Creates a new nested PercentageSlider. These store values in the range 0.0-1.0 and display them in the range 0%-100%. All MCM related settings refer to the **displayed** values.]],
	arguments = {{
		name = "data",
		type = "table",
		tableParams = {
			...
			{ name = "min", type = "number", optional = true, default = 0.0, description = "Minimum (displayed) value of slider." },
			{ name = "max", type = "number", optional = true, default = 100, description = "Maximum (displayed) value of slider." },
