...
!!! tip
	...
	arguments = {{
		...
		type = "table",
		tableParams = {
			{ name = "type", type = "integer|mwseTimer.type", optional = true, default = "`timer.simulate`", description = "Type of the timer. This value can be `timer.simulate`, `timer.game` or `timer.real`." },
