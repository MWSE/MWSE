...
---
--- [Examples available in online documentation](https://mwse.github.io/MWSE/events/magicEffectBegan).
--- @class magicEffectBeganEventData
...
--- @field effectInstance tes3magicEffectInstance *Read-only*. The unique instance of the magic effect that caused the source effect to begin.
...
--- @field target tes3reference *Read-only*. The target of the magic effect instance that caused the source effect to begin.
