...
---
--- [Examples available in online documentation](https://mwse.github.io/MWSE/events/magicEffectRetired).
--- @class magicEffectRetiredEventData
...
--- @field target tes3reference *Read-only*. The target of the magic effect.
