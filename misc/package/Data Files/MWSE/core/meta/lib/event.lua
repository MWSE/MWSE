...
--- @field register fun(eventId: '"magicEffectBegan"', callback: (fun(e: magicEffectBeganEventData): boolean?), options: table?)
--- @field register fun(eventId: '"magicEffectRemoved"', callback: (fun(e: magicEffectRemovedEventData): boolean?), options: table?)
--- @field register fun(eventId: '"magicEffectRetired"', callback: (fun(e: magicEffectRetiredEventData): boolean?), options: table?)
