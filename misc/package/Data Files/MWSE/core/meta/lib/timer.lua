...
--- @alias mwseTimer.state
---| `timer.active`
---| `timer.paused`
---| `timer.expired`

--- @alias mwseTimer.type
---| `timer.real`
---| `timer.simulate`
---| `timer.game`
...
--- @param type? integer|mwseTimer.type *Default*: ``timer.simulate``. Type of the timer. This value can be `timer.simulate`, `timer.game` or `timer.real`.
...
--- @field type? integer|mwseTimer.type *Default*: ``timer.simulate``. Type of the timer. This value can be `timer.simulate`, `timer.game` or `timer.real`.
