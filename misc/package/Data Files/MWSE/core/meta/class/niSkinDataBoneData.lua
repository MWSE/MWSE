...
--- @field weights niSkinDataBoneDataVertexWeight[] *Read-only*. Contains all the per-vertex weight coefficients used when deforming the vertices influenced by this bone.
