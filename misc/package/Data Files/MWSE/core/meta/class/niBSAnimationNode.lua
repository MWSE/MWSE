...
--- @field animationFlags integer A bit field of animation flags. The engine sets and clears these flags while the game runs. NIF files do not contain these flags.
--- 
