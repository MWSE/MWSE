...
--- @field isWearableByBeasts boolean *Read-only*. If this property is `true`, beast races can wear this clothing item. This property is `false` for any kind of clothing that covers feet.
