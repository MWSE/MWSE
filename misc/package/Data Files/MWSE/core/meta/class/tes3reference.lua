...
--- @field startingOrientation tes3vector3 *Read-only*. Access to the reference's starting orientation.
--- @field startingPosition tes3vector3 *Read-only*. Access to the reference's starting position.
