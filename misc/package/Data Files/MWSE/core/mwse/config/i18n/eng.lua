return {
	...
	["replaceLightFlicker.label"] = "Replace light flicker?",
	["replaceLightFlicker.description"] = "If enabled, flickering and pulsing lights change brightness at a pace that does not depend on the frame rate. Morrowind updates them once per rendered frame, which makes lights flicker faster and less deeply the higher the frame rate. The replacement eases each light towards its next brightness, at the pace chosen below. Changes take effect immediately.",
	["lightFlickerReferenceFPS.label"] = "Light flicker pace",
	["lightFlickerReferenceFPS.description"] = "Only used when light flicker is replaced. Morrowind's lights flicker at a different pace depending on the frame rate. This picks which frame rate's pace the replacement reproduces. 15 FPS is the rate the original was designed around and is the calmer of the two. Changes take effect immediately.",
	["lightFlickerReferenceFPS.option15"] = "As the original at 15 FPS",
	["lightFlickerReferenceFPS.option30"] = "As the original at 30 FPS",
