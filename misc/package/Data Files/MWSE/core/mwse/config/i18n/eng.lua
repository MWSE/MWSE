return {
	...
	["antiJitterFix.label"] = "Anti-Jitter Fix?",
	["antiJitterFix.description"] = "MWSE adjusts NiNode display for some actors so they can be rendered correctly when their origin is far from the world origin (~20 cells out). Enabling this option bypasses that custom logic and restores the game's original display behavior.\n\nIf you encounter issues, please report them to the #mwse channel in the Morrowind Modding Community Discord.",
