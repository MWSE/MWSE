			...
			components = {
				{
					...
					components = {
						...
						},
						{
							...
							variable = { id = "OcclusionCullLights", class = "TableVariable", table = mwseConfig },
						},
						{
							class = "Slider",
							label = i18n("occlusionLightCullHysteresisFrames.label"),
							description = i18n("occlusionLightCullHysteresisFrames.description"),
							min = 0, max = 5, step = 1, jump = 5,
							variable = { id = "OcclusionLightCullHysteresisFrames", class = "TableVariable", table = mwseConfig },
						},
						{
							class = "Slider",
