...
namespace se::cs::dialog::landscape_edit_settings_window {
	...
	constexpr UINT CONTROL_ID_VERTEX_COLOR_STRENGTH_STATIC = 2013;
	constexpr UINT CONTROL_ID_VERTEX_COLOR_STRENGTH_EDIT = 2014;
	constexpr UINT CONTROL_ID_VERTEX_COLOR_STRENGTH_SPIN = 2015;
	constexpr UINT CONTROL_ID_VERTEX_COLOR_BLEND_MODE_STATIC = 2016;
	constexpr UINT CONTROL_ID_VERTEX_COLOR_BLEND_MODE_COMBO = 2017;
