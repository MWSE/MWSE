# magicEffectRetired
<div class="search_terms" style="display: none">magiceffectretired</div>
...
```lua
--- @param e magicEffectRetiredEventData
local function magicEffectRetiredCallback(e)
end
event.register(tes3.event.magicEffectRetired, magicEffectRetiredCallback)
```
...
[magicEffectBegan](./magicEffectBegan.md){ .md-button }[magicEffectRemoved](./magicEffectRemoved.md){ .md-button }[spellTick](./spellTick.md){ .md-button }
