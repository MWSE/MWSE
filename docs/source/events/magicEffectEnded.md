# magicEffectEnded
<div class="search_terms" style="display: none">magiceffectended</div>
...
local function magicEffectEndedCallback(e)
end
event.register(tes3.event.magicEffectEnded, magicEffectEndedCallback)
```
...
* `effectInstance` ([tes3magicEffectInstance](../types/tes3magicEffectInstance.md)): *Read-only*. The unique instance of the magic effect that caused the source effect to end.
...
* `target` ([tes3reference](../types/tes3reference.md)): *Read-only*. The target of the magic effect instance that caused the source effect to end.
...
[magicEffectActivated](./magicEffectActivated.md){ .md-button }[magicEffectBegan](./magicEffectBegan.md){ .md-button }[magicEffectDeactivated](./magicEffectDeactivated.md){ .md-button }[magicEffectRemoved](./magicEffectRemoved.md){ .md-button }[spellTick](./spellTick.md){ .md-button }
